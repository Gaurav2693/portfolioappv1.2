...
import { Linkedin, Instagram, Mail, Phone, Check } from 'lucide-react';
import Header from '@/app/components/Header';
import NavigationSidebar from '@/app/components/NavigationSidebar';
import ContactMobile from '@/app/pages/ContactMobile';
          ...
          >
            <div className="h-[34px] overflow-clip relative shrink-0 w-full">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
                <path d={svgPaths.p2c011100} fill={socialCircleFill} />
              </svg>
