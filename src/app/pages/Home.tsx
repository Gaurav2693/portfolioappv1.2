...
import ProfileIllustration from "@/app/components/ProfileIllustration";
import FramingDecisionsIcon from "@/app/components/FramingDecisionsIcon";
...
import HomeMobile from "@/app/pages/HomeMobile";
      ...
      <div className={`hidden lg:flex ${outerBg} min-h-screen w-full items-start justify-center py-[74px] overflow-auto`}>
        <div className="relative w-[1315px] h-[893px]">
          ...
          <div className="animate-fadeIn">
            <div className="absolute h-[250px] left-[69px] top-[186px] w-[179px] delay-400">
              <ProfileIllustration />
            </div>
            
            <div className={`-translate-y-1/2 absolute flex flex-col font-['Caladea',serif] h-[100px] justify-center leading-[0] left-[294px] not-italic text-[64px] ${textColor} top-[226px] tracking-[0.64px] w-[433px] delay-500`}>
            ...
            <div className={`-translate-y-1/2 absolute flex flex-col font-['Cambay',sans-serif] font-bold justify-center leading-[0] left-[299px] not-italic text-[24px] ${textColor} top-[301px] tracking-[0.24px] w-[482px] delay-600`}>
            ...
            <div className={`-translate-y-1/2 absolute flex flex-col font-['Cambay',sans-serif] justify-center leading-[0] left-[299px] not-italic text-[16px] ${textColor} top-[392px] tracking-[0.16px] w-[482px] delay-700`}>
